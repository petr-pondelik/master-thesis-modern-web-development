...
import { CustomInput } from 'features/core';
import { UpdateReadingListContent } from 'services/graphql-api-service';
...
export const ReadingListForm = (props: ReadingListFormProps) => {
  ...
  const update = (dtoFragment: Partial<UpdateReadingListContent>, validationFragment: any) => {
