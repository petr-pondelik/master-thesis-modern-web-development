import { findLink, HttpRequest, ReadingListEnvelope, StoryCollectionEnvelope } from 'services/rest-api-service';
...
export const ReadingListCard = (
  ...
  const { data: stories, isLoading: storiesLoading, error: storiesError, refetch: storiesRefetch }
    ...
    ['reading-list-stories', readingList.id], fetchMethod,
  );
