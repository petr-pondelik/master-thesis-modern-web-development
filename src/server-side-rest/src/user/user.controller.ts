...
export class UserController {
  ...
  async findStories(
    ...
    const stories = await this.userService.findStories({ id: _id }, take);
  ...
  async findUsersReadingLists(
    ...
    const readingLists = await this.userService.findReadingLists({ id: _id }, take);
  ...
  async findReadingListStories(
    ...
    const stories = await this.readingListService.findStories(
      { title_authorId: { authorId: id, title: title } },
      take
    );
    const envelope = new StoryCollectionEnvelope(stories);
    addLinks(envelope, [
